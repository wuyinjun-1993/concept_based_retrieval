...
class EvaluateRetrieval:
    ...
    def retrieve(self, corpus: Dict[str, Dict[str, str]], queries: Dict, query_negations:Dict=None, all_sub_corpus_embedding_ls=None,query_embeddings=None, query_count=10, **kwargs) -> Dict[str, Dict[str, float]]:
