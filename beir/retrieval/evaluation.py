...
class EvaluateRetrieval:
    ...
    def retrieve(self, corpus: Dict[str, Dict[str, str]], queries: Dict, query_negations:Dict=None, all_sub_corpus_embedding_ls=None, **kwargs) -> Dict[str, Dict[str, float]]:
        if not self.retriever:
            raise ValueError("Model/Technique has not been provided!")
        return self.retriever.search(corpus, queries, self.top_k, self.score_function, query_negations=query_negations, all_sub_corpus_embedding_ls=all_sub_corpus_embedding_ls,**kwargs)
