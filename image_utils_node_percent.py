...
def load_flickr_dataset_full0(data_path, query_path, subset_img_id=None, redecompose=False, total_count = 1000, algebra_method="five"):
    ...
    decomposed_res_file_name = "flickr_100_result.txt"
    ...
    if subset_img_id is not None:
        ...
        selected_img_idx = subset_img_id
        
        img_path = '/content/unzipped_images_fixed/flickr/'
        image_path_11 = os.path.join(img_path, "flickr30k-images/") + query_df.iloc[selected_img_idx]['filename']
        ...
        if algebra_method == "five":
            ...
            with open(decomposed_res_file, 'r') as f:
                for line in f:
                    tree, node_count, cnt_node_count, max_tgt_count, total_tgt_count = construct_tree_from_string(line)
    ...
    return caption_ls, img_file_name_ls, sub_caption_ls, img_idx_ls, all_grouped_sub_q_ids_ls, node_count_list, cnt_node_count_list, max_tgt_count_list, total_tgt_count_list
